...
<script>
  ...
  import NavBar from 'common/navbar/NavBar'
    ...
    data: function () {
		  return {
		    orderList: [
          {icon: require('../../assets/img/profile/xiaoxi.png'), info: '我的消息'},
          {icon: require('../../assets/img/profile/shop.png'),  info: '积分商城'},
          {icon: require('../../assets/img/profile/huiyuan.png'), info: '会员卡'},
          {icon: require('../../assets/img/profile/cart.png'), info: '我的购物车'},
          {icon: require('../../assets/img/profile/xiazai.png'), info: '下载购物APP'},
        ],
      }
    },
    mounted: function () {
